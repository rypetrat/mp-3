      ...
      <>
        ...
        <div id="documents">
            <div id="documents-image">
                <h3>Resume:</h3>
                <img src="../src/assets/res1.png" id="resume-image" alt="Page 1 of Ryan Petrat's Resume"/>
            </div>
            <div id="documents-other">
                <h3>Other:</h3>
                <ul>
                    <li><a target="_blank" href="../src/assets/RyanPetratResume.pdf">PDF of my Resume</a></li>
